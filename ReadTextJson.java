...
public class ReadTextJson {
    public static void main(String[] args) throws AnalysisException {
        ...
        Dataset<Row> data = session.read().option("multiline","false").json("D:\\IIE\\ucas\\SparkJsonTest\\src\\main\\java\\test.txt");
        //data.write().parquet("D:\\IIE\\ucas\\SparkJsonTest\\src\\main\\java\\tttt");
